...
bool group_15__srv__start_perception_test__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("group_15.srv._start_perception_test.StartPerceptionTest_Request", full_classname_dest, 63) == 0);
  }
  group_15__srv__StartPerceptionTest_Request * ros_message = _ros_message;
  {  // banner_a
...
PyObject * group_15__srv__start_perception_test__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("group_15.srv._start_perception_test");
...
ROSIDL_GENERATOR_C_EXPORT
bool group_15__srv__start_perception_test__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("group_15.srv._start_perception_test.StartPerceptionTest_Response", full_classname_dest, 64) == 0);
  }
  group_15__srv__StartPerceptionTest_Response * ros_message = _ros_message;
  {  // answer
