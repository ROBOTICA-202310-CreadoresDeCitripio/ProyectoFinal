...
#ifndef GROUP_15__SRV__DETAIL__START_MANIPULATION_TEST__FUNCTIONS_H_
#define GROUP_15__SRV__DETAIL__START_MANIPULATION_TEST__FUNCTIONS_H_
 ...
 * calls
 * group_15__srv__StartManipulationTest_Request__init().
...
/**
 * It calls
 * group_15__srv__StartManipulationTest_Request__fini()
 ...
 * group_15__srv__StartManipulationTest_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * group_15__srv__StartManipulationTest_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * group_15__srv__StartManipulationTest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_group_15
...
/**
 * It calls
 * group_15__srv__StartManipulationTest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_group_15
...
/**
 * It allocates the memory for the array and calls
 * group_15__srv__StartManipulationTest_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_group_15
...
/**
 * It calls
 * group_15__srv__StartManipulationTest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GROUP_15__SRV__DETAIL__START_MANIPULATION_TEST__FUNCTIONS_H_
