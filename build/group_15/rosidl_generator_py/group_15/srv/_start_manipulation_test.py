...
class Metaclass_StartManipulationTest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'group_15.srv.StartManipulationTest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from group_15.srv import _start_manipulation_test
...
class StartManipulationTest(metaclass=Metaclass_StartManipulationTest):
    from group_15.srv._start_manipulation_test import StartManipulationTest_Request as Request
    from group_15.srv._start_manipulation_test import StartManipulationTest_Response as Response
