...
#include "group_15/srv/detail/start_manipulation_test__rosidl_typesupport_fastrtps_c.h"
...
using _StartManipulationTest_Request__ros_msg_type = group_15__srv__StartManipulationTest_Request;
...
size_t get_serialized_size_group_15__srv__StartManipulationTest_Request(
  const void * untyped_ros_message,
...
static uint32_t _StartManipulationTest_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_group_15__srv__StartManipulationTest_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_group_15
size_t max_serialized_size_group_15__srv__StartManipulationTest_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _StartManipulationTest_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_group_15__srv__StartManipulationTest_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, group_15, srv, StartManipulationTest_Request)() {
...
using _StartManipulationTest_Response__ros_msg_type = group_15__srv__StartManipulationTest_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_group_15
size_t get_serialized_size_group_15__srv__StartManipulationTest_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartManipulationTest_Response__ros_msg_type * ros_message = static_cast<const _StartManipulationTest_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_group_15__srv__StartManipulationTest_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_group_15
size_t max_serialized_size_group_15__srv__StartManipulationTest_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _StartManipulationTest_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_group_15__srv__StartManipulationTest_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, group_15, srv, StartManipulationTest_Response)() {
...
// already included above
// #include "group_15/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "group_15/srv/start_manipulation_test.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, group_15, srv, StartManipulationTest)() {
