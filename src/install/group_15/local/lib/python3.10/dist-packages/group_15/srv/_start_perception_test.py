...
class Metaclass_StartPerceptionTest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'group_15.srv.StartPerceptionTest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from group_15.srv import _start_perception_test
...
class StartPerceptionTest(metaclass=Metaclass_StartPerceptionTest):
    from group_15.srv._start_perception_test import StartPerceptionTest_Request as Request
    from group_15.srv._start_perception_test import StartPerceptionTest_Response as Response
